...
<body>
    ...
    <div class="container contact-section">
        ...
        <div class="contact-form">
            <form action="jeffers0ncamargo208@gmail.com" method="post" enctype="text/plain" id="userForm">
                ...
                <button onclick="enviarCorreo()" type="submit">Send Message</button>
            </form>
        </div>

        <div>
            <a href="<?php echo $url_con; ?>" class="btn btn-success">
                sistema para gestionar las consultas - Solo ingresar personal "hacer click"
            </a>
        </div>
    </div>
    ...
    <!-- Bootstrap & Popper (versión unificada - solo Bootstrap 5) -->
    <script
